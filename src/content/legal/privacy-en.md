...
>
> This document is a **template** prepared by a language model. It is **not legal advice**. Before publishing it on the live site:
>
> 1. Have it reviewed by a Bulgarian data protection professional or solicitor familiar with the GDPR, the Bulgarian Personal Data Protection Act (PDPA / ЗЗЛД), and the ePrivacy regime.
> 2. Verify the **processor list** in §6 against what you actually use at launch. Add or remove vendors. Confirm each one has signed a Data Processing Agreement (DPA) with you.
> 3. Verify the **transfer mechanisms** in §7 — the legal basis for any data leaving the EEA has changed multiple times in recent years.
> 4. Fill in every `[PLACEHOLDER:*]` marker.
> 5. Set a real **effective date** at the top.
> 6. Translate to Bulgarian — the §16 section is a starting point but **must** be reviewed by a native-speaker legal professional. The Bulgarian version is the one that will matter if a Bulgarian customer disputes anything in court.
>
...
## 16. Политика за поверителност (Bulgarian translation — DRAFT, requires legal review)

> **Notice:** The following Bulgarian section is a translation provided as a starting point. **Before publishing the site, this section must be reviewed and corrected by a Bulgarian-speaking legal professional.** In the event of any inconsistency between the English version above and the Bulgarian version below, the Bulgarian version will likely govern for Bulgarian-resident customers under local law. Verify with counsel.

`[PLACEHOLDER:bulgarian_translation_to_be_reviewed_by_professional]`

A working draft Bulgarian translation should mirror sections 1–15 above, using the following key terminology:

- "personal data" → "лични данни"
- "data controller" → "администратор на лични данни"
- "data subject" → "субект на данните"
- "lawful basis" → "правно основание"
- "processing" → "обработване"
- "consent" → "съгласие"
- "data processing agreement" → "споразумение за обработване на лични данни"
- "Commission for Personal Data Protection" → "Комисия за защита на личните данни (КЗЛД)"

Recommend engaging a Bulgarian solicitor for the final translation (estimated cost: a few hundred euros for a document of this size; far less than a single GDPR fine).
