...
**Версия:** 1.0
**Документът е прегледан последно на:** `[PLACEHOLDER:review_date_bg]`

---

## 1. Кой сме ние

Тази политика за поверителност описва как `[PLACEHOLDER:legal_entity_name_bg]` ("ние", "нас", "наш" или "Puro Barbershop"), операторът на фризьорския салон Puro Barbershop, разположен на бул. Христо Ботев 114, Пловдив, България, обработва лични данни относно посетителите на нашия уебсайт на **purobarbershop.com** и клиентите, които го използват за резервации.

**Администратор на лични данни:**

- **Правно име:** `[PLACEHOLDER:legal_entity_name_bg]`
- **ЕИК:** `[PLACEHOLDER:eik]`
- **Данъчен номер (при наличие):** `[PLACEHOLDER:vat_id]`
- **Регистриран адрес:** `[PLACEHOLDER:registered_address_bg]`
...
| -------------------------------------- | ------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| Neon, Inc. (САЩ)                       | Хостинг на база данни (Postgres)                              | Всички данни за резервации и акаунти, съхранявани в покой                                       | Регион на ЕС (`[PLACEHOLDER:neon_region]`)                          |
| Vercel Inc. (САЩ)                      | Хостинг на уебсайт и маршрутизация на заявки                  | Всички уеб трафик; обработва данни в паметта по време на обработка на заявки                    | Регион на ЕС (`[PLACEHOLDER:vercel_region]`)                        |
| Resend (САЩ)                           | Доставка на транзакционни имейли                              | Имейл адрес на получателя, тема и тяло на имейла (име, детайли за резервация, връзка за отмяна) | Регион на ЕС, където е възможно (`[PLACEHOLDER:resend_region]`)     |
| Upstash, Inc. (САЩ)                    | Състояние на ограничаване на честотата (Redis)                | Хеширани идентификатори на скорошни опити за резервация (IP, имейл, телефон) — краткотрайни     | Регион на ЕС (`[PLACEHOLDER:upstash_region]`)                       |
| Cloudinary Ltd. (Израел)               | Хостинг на изображения за портрети на фризьори и качени медии | Изображения, които ние качваме (не клиентски данни)                                             | Регион на ЕС, където е възможно (`[PLACEHOLDER:cloudinary_region]`) |
...
Можете да поискате копие на мерките за всеки конкретен трансфер, като се свържете с нас на `[PLACEHOLDER:shop_email]`.
...
За да упражните което и да е от правата в §8, изпратете имейл на **`[PLACEHOLDER:shop_email]`** с:
...
Ако смятате, че не сме обработили личните ви данни съгласно закона, първо се свържете с нас на `[PLACEHOLDER:shop_email]` — взимаме жалбите на сериозно и искаме да имаме възможност да разрешим въпроса.
...
- **Имейл:** `[PLACEHOLDER:shop_email]`
- **Телефон:** `[PLACEHOLDER:shop_phone]`
- **Адрес:** `[PLACEHOLDER:registered_address_bg]`
